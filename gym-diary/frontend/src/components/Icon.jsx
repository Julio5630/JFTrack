const icons = {
  ...
  eyeOff: <><path d="m3 3 18 18" /><path d="M10.6 6.2A10.5 10.5 0 0 1 12 6c6 0 9.5 6 9.5 6a15 15 0 0 1-2.1 2.8" /><path d="M6.6 6.6C4 8.3 2.5 12 2.5 12S6 18 12 18a9 9 0 0 0 3.4-.7" /><path d="M10.3 10.3a2.5 2.5 0 0 0 3.4 3.4" /></>,
